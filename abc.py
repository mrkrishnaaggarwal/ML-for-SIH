...
def search_faces():
    ...
    try:
        ...
        # Extract faces from the query image (processing one face at a time)
        ...
        for saved_face_file in os.listdir(SAVE_DIR):
            ...
            try:
                ...
                for query_face in query_faces:
                    ...
                    # Compare the faces using DeepFace without passing the model directly
                    result = DeepFace.verify(query_face_array, saved_face_array, model_name='ArcFace', distance_metric='euclidean_l2')
